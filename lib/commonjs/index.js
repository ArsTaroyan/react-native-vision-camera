...
var _useWhiteBalanceShadingCorrection = require("./skia/useWhiteBalanceShadingCorrection");
Object.keys(_useWhiteBalanceShadingCorrection).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _useWhiteBalanceShadingCorrection[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _useWhiteBalanceShadingCorrection[key];
    }
  });
});
